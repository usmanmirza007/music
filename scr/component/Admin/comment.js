...
export default class comment extends React.Component {
    constructor(props) {
        ...
        this.state = {
            showMe: false,
            item: [
                { key: 1, folder: 'Folder Name', date: 'Date Created', option: 'options-vertical', folderIcon: 'music' },
                { key: 2, folder: 'Folder Name', date: 'Date Created', option: 'options-vertical', folderIcon: 'music' },
                { key: 3, folder: 'Folder Name', date: 'Date Created', option: 'options-vertical', folderIcon: 'music' },
                { key: 4, folder: 'Folder Name', date: 'Date Created', option: 'options-vertical', folderIcon: 'music' },
                { key: 5, folder: 'Folder Name', date: 'Date Created', option: 'options-vertical', folderIcon: 'music' },
                { key: 6, folder: 'Folder Name', date: 'Date Created', option: 'options-vertical', folderIcon: 'music' },
                { key: 7, folder: 'Folder Name', date: 'Date Created', option: 'options-vertical', folderIcon: 'music' },
                { key: 8, folder: 'Folder Name', date: 'Date Created', option: 'options-vertical', folderIcon: 'music' },
            ]
        };
    }
    renderRow = ({ item }) => {
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.main}>
                    <Text style={styles.cooked}>Comments</Text>
                    <FlatList
                        // numColumns={2}
